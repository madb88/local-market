...
export default function HomeLayout({ children }: { children: React.ReactNode }) {
	return (
		<>
			<main className="flex h-screen flex-col bg-slate-100 dark:bg-slate-600 md:flex-row md:overflow-hidden">
				<div className="order-2 hidden md:order-1 md:flex">
					<Navigation />
				</div>
				<div className="order-1 h-full overflow-scroll pb-10 md:order-2">{children}</div>
			</main>
